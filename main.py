...
from tools.engine import evaluate, train_one_epoch
from model import build_model
# from models_official import build_model
...
def main(args):
    ...
    if args.distributed:
        sampler_train = DistributedSampler(dataset_train) # 启用分布式训练，将数据随机进行划分并分配到不同GPU上面
