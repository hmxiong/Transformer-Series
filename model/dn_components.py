...
def prepare_for_cdn(dn_args, training, num_queries, num_classes,hidden_dim, label_enc):
    if training :
        ...
        if label_noise_ratio > 0:
            ...
            new_labels = torch.randint_like(chosen_indice, 0, num_classes)
            known_labels_expand.scatter_(0, chosen_indice, new_labels)
...
def dn_post_process(outputs_class, outputs_coord, mask_dict, aux_loss=False, _set_aux_loss=False):
