...
class DeformableTransformer(nn.Module):
    def __init__(self, ffn_hidden_dim=256, nhead=8,
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None):
        ...
        # print("reference shape: "+str(reference_points.shape))
        # print("memory shape: "+str(memory.shape))
        # print("spatial_shapes shape: "+str(spatial_shapes.shape))
        # print("level_start_index shape: "+str(level_start_index.shape))
        # print("valid_ratios shape: "+str(valid_ratios.shape))
        # print("query_embed shape: "+str(query_embed.shape))
        # print("mask_flatten shape: "+str(mask_flatten.shape))
...
class DeformableTransformerDecoderLayer(nn.Module):
    def __init__(self, ffn_hidden_dim=256, d_ffn=1024,
                 dropout=0.1, activation="relu",
                 n_levels=4, n_heads=8, n_points=4):
        super().__init__()
