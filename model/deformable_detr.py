...
def build_deformable_detr(args):
    ...
    criterion = SetCriterion(num_classes, matcher, weight_dict, losses, focal_alpha=args.focal_alpha,losses=losses, model_type=model_type)
    criterion.to(device)
